...
game_controls = pygame.image.load(os.path.join('sprites', 'GAME CONTROLS.png'))
...
background = pygame.transform.scale(pygame.image.load(os.path.join('sprites', 'background-day.png')), [screen_width, screen_height])
base = pygame.transform.scale(pygame.image.load(os.path.join('sprites', 'base.png')), [screen_width, 50])
pipe_not_final = pygame.image.load(os.path.join('sprites', 'pipe-green.png'))
pipe = pygame.transform.scale(pipe_not_final, [pipe_not_final.get_width(), pipe_not_final.get_height() - 65])
pipe_red_not_final = pygame.image.load(os.path.join('sprites', 'pipe-red.png'))
pipe_red = pygame.transform.scale(pipe_red_not_final, [pipe_not_final.get_width(), pipe_not_final.get_height() - 75])


# Red bird upflap
red_bird_upflap_not_final = pygame.image.load(os.path.join('sprites', 'redbird-upflap.png'))
...
# Red bird midflap
red_bird_midflap_not_final = pygame.image.load(os.path.join('sprites', 'redbird-midflap.png'))
red_bird_midflap = pygame.transform.scale(red_bird_midflap_not_final, [bird_width, bird_height])
 

# Red bird downflap
red_bird_downflap_not_final = pygame.image.load(os.path.join('sprites', 'redbird-downflap.png'))
red_bird_downflap = pygame.transform.scale(red_bird_downflap_not_final, [bird_width, bird_height])

# Sound-
hiscore_broken_sound = pygame.mixer.Sound(os.path.join('audio', 'point.ogg'))
hit_sound = pygame.mixer.Sound(os.path.join('audio', 'hit.wav'))
wing_sound = pygame.mixer.Sound(os.path.join('audio', 'wing.wav'))
point_sound = pygame.mixer.Sound(os.path.join('audio', 'point.wav'))
night_back = pygame.transform.scale(pygame.image.load(os.path.join('sprites', 'background-night.png')), [screen_width, screen_height])
